            ...
            <div className='grid mb-8 lg:grid-cols-6' >
                <div className='grid grid-cols-2 gap-5 lg:col-span-4  md:grid-cols-4 '>
                    ...
                    <div >
                        ...
                        <ul className='mt-2 space-y-2 '>
                            ...
                            <li><a href="/" className='text-gray-500 transition-colors duration-300  hover:text-orange-500' >Buisness</a></li>
                    ...
                    <div >
                        ...
                        <ul className='mt-2 space-y-2 '>
                            ...
                            <li><a href="/" className='text-gray-500 transition-colors duration-300  hover:text-orange-500' >Bronchure</a></li>
                    ...
                    <div >
                        ...
                        <ul className='mt-2 space-y-2 '>
                            ...
                            <li><a href="/" className='text-gray-500 transition-colors duration-300  hover:text-orange-500' >WEbkit</a></li>
                ...
                <div className='md:mx-w-md lg:col-span-2 lg:mt-0 mt-5' >
                        ...
                        <form className='mt-4 flex flex-col md:flex-row'>
                            ...
                            rounded shadow-md hover:bg-orange-500 focus:outline-none border '>Subscribe</button>
                        </form>
                        <p className='mt-4 text-sm   text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla, excepturi eveniet. Quidem eaque, eligendi, sequi temporibus quisquam a provident id repellendus itaque voluptate ipsam perspiciatis adipisci explicabo consectetur, harum omnis.</p>

                    </div>
                
            </div>
            <div className='flex flex-col justify-between pt-5 pb-10 bortder-t border-gray-800 sm:flex-row'>
